    ...
    return (
        ...
        <div className="background-menu-bar">
            ...
            <ul className="background-menu-bar__menu-bar__menus" >
                <li>
                  <Link to='home' smooth={true} offset={-100} duration={500}><label onClick={toggle}>Home</label></Link>
                </li>
                <li><Link to='sobre' smooth={true} offset={-100} duration={500} ><label onClick={toggle}>Sobre</label></Link></li>
                <li><Link to='servicos' smooth={true} offset={-100} duration={500}><label onClick={toggle}>Serviços</label></Link></li>
                <li><Link to='contato' smooth={true} offset={-100} duration={500}><label onClick={toggle}>Contato</label></Link></li>
